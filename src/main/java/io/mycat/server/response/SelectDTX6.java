 ...
 * @author mycat
 */
public final class SelectDTX6
{
    private static final Logger LOGGER = LoggerFactory.getLogger(SelectDTX6.class);


    public static void execute(ServerConnection c, String sql) {


    List<String>  splitVar= Lists.newArrayList( "table_collation") ;
...
//
//        }
        List<String> values = Lists.newArrayList("customers");
