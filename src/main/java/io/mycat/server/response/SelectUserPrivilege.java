 ...
 * @author mycat
 */
public final class SelectUserPrivilege
{
    private static final Logger LOGGER = LoggerFactory.getLogger(SelectUserPrivilege.class);


    public static void execute(ServerConnection c, String sql) {


        List<String> splitVar = Lists.newArrayList("grantee", "privilege_type");
...
//        }
        ...
        for (String name : values) {
            RowDataPacket row = new RowDataPacket(FIELD_COUNT);
            row.add(StringUtil.encode("'czn'@'%'", c.getCharset()));
